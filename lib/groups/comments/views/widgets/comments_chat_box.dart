...
class CommentsChatBox extends StatelessWidget {
  const CommentsChatBox({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(
      bottom: 85,
      child: BlocSelector<CommentsBloc, CommentsState, List<CommentFile>?>(
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: CircleAvatar(
                        ...
                        child: IconButton(
                          onPressed: () =>
                              bloc.add(CommentsFileDelete(index, file.key!)),
                          icon: AppImage.asset(
