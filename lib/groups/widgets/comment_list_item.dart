...
class CommentListItem extends StatelessWidget {
  ...
  final void Function(Comment)? onSelected;
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: AppImage.asset(
                      comment.user!.photoBase64 ?? ImageConstant.profileAvatar,
                      width: 38,
                      height: 38,
                      fit: BoxFit.cover,
                    ),
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(
                          timeago.format(comment.createdAt!.getDateTimeInUtc()),
                          textAlign: TextAlign.left,
                          style: Theme.of(context)
                              .textTheme
                              .bodySmall
                    ...
                    Row(
                      children: [
                        ...
                        VoteButton(
                          ...
                          isVoted: isVoted,
                          numberOfVotes: comment.numberOfVotes ?? 0,
                        ),
                      ],
                    ),
                    if (files.isNotEmpty) ...[
