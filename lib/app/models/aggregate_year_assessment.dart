...
/** This is an auto generated class representing the AggregateYearAssessment type in your schema. */
class AggregateYearAssessment extends amplify_core.Model {
  static const classType = const _AggregateYearAssessmentModelType();
  final String id;
  ...
  bool operator ==(Object other) {
    ...
    return other is AggregateYearAssessment &&
      id == other.id &&
  ...
  String toString() {
    ...
    buffer.write("AggregateYearAssessment {");
    buffer.write("id=" + "$id" + ", ");
  ...
  AggregateYearAssessment copyWith({String? id, amplify_core.TemporalDateTime? startDate, amplify_core.TemporalDateTime? endDate, String? latestMood, String? latestStressLevel, double? averageOxygenLevel, double? averageOxygenSaturationLevel, double? averageRespiratoryRate, double? averageStressIndex, double? averageBodyTemperature, double? averageSystolicBloodPressure, double? averageDiastolicBloodPressure, double? averageHeartRate, double? averageHeartRateVariability, double? averageSympatheticNervousSystemIndex, double? averageScore, int? numberOfAssessments, String? profileID}) {
    return AggregateYearAssessment._internal(
      id: id ?? this.id,
  ...
  AggregateYearAssessment copyWithModelFieldValues({
  ...
  AggregateYearAssessment.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "AggregateYearAssessment";
    modelSchemaDefinition.pluralName = "AggregateYearAssessments";
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateYearAssessment.STARTDATE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.dateTime)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateYearAssessment.ENDDATE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.dateTime)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateYearAssessment.LATESTMOOD,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateYearAssessment.LATESTSTRESSLEVEL,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateYearAssessment.AVERAGEOXYGENLEVEL,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateYearAssessment.AVERAGEOXYGENSATURATIONLEVEL,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateYearAssessment.AVERAGERESPIRATORYRATE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateYearAssessment.AVERAGESTRESSINDEX,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateYearAssessment.AVERAGEBODYTEMPERATURE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateYearAssessment.AVERAGESYSTOLICBLOODPRESSURE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateYearAssessment.AVERAGEDIASTOLICBLOODPRESSURE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateYearAssessment.AVERAGEHEARTRATE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateYearAssessment.AVERAGEHEARTRATEVARIABILITY,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateYearAssessment.AVERAGESYMPATHETICNERVOUSSYSTEMINDEX,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateYearAssessment.AVERAGESCORE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateYearAssessment.NUMBEROFASSESSMENTS,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateYearAssessment.PROFILEID,
      isRequired: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
...
class _AggregateYearAssessmentModelType extends amplify_core.ModelType<AggregateYearAssessment> {
  const _AggregateYearAssessmentModelType();
  
  @override
  AggregateYearAssessment fromJson(Map<String, dynamic> jsonData) {
    return AggregateYearAssessment.fromJson(jsonData);
  }
  
  @override
  String modelName() {
    return 'AggregateYearAssessment';
  }
}
