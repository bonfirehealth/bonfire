...
class Professional extends amplify_core.Model {
  ...
  const Professional._internal({required this.id, required providerID, createdAt, updatedAt}): _providerID = providerID, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Professional({String? id, required String providerID}) {
  ...
  Professional copyWith({String? id, String? providerID}) {
    return Professional._internal(
      id: id ?? this.id,
      providerID: providerID ?? this.providerID);
  }
  
  Professional copyWithModelFieldValues({
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'providerID': _providerID, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.indexes = [
      amplify_core.ModelIndex(fields: const ["providerID"], name: "byProvider")
    ];
...
class _ProfessionalModelType extends amplify_core.ModelType<Professional> {
