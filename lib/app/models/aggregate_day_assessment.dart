...
/** This is an auto generated class representing the AggregateDayAssessment type in your schema. */
class AggregateDayAssessment extends amplify_core.Model {
  static const classType = const _AggregateDayAssessmentModelType();
  final String id;
  ...
  bool operator ==(Object other) {
    ...
    return other is AggregateDayAssessment &&
      id == other.id &&
  ...
  String toString() {
    ...
    buffer.write("AggregateDayAssessment {");
    buffer.write("id=" + "$id" + ", ");
  ...
  AggregateDayAssessment copyWith({String? id, amplify_core.TemporalDateTime? startDate, amplify_core.TemporalDateTime? endDate, String? latestMood, String? latestStressLevel, double? averageOxygenLevel, double? averageOxygenSaturationLevel, double? averageRespiratoryRate, double? averageStressIndex, double? averageBodyTemperature, double? averageSystolicBloodPressure, double? averageDiastolicBloodPressure, double? averageHeartRate, double? averageHeartRateVariability, double? averageSympatheticNervousSystemIndex, double? averageScore, int? numberOfAssessments, String? profileID}) {
    return AggregateDayAssessment._internal(
      id: id ?? this.id,
  ...
  AggregateDayAssessment copyWithModelFieldValues({
  ...
  AggregateDayAssessment.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "AggregateDayAssessment";
    modelSchemaDefinition.pluralName = "AggregateDayAssessments";
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateDayAssessment.STARTDATE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.dateTime)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateDayAssessment.ENDDATE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.dateTime)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateDayAssessment.LATESTMOOD,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateDayAssessment.LATESTSTRESSLEVEL,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateDayAssessment.AVERAGEOXYGENLEVEL,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateDayAssessment.AVERAGEOXYGENSATURATIONLEVEL,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateDayAssessment.AVERAGERESPIRATORYRATE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateDayAssessment.AVERAGESTRESSINDEX,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateDayAssessment.AVERAGEBODYTEMPERATURE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateDayAssessment.AVERAGESYSTOLICBLOODPRESSURE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateDayAssessment.AVERAGEDIASTOLICBLOODPRESSURE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateDayAssessment.AVERAGEHEARTRATE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateDayAssessment.AVERAGEHEARTRATEVARIABILITY,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateDayAssessment.AVERAGESYMPATHETICNERVOUSSYSTEMINDEX,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateDayAssessment.AVERAGESCORE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateDayAssessment.NUMBEROFASSESSMENTS,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateDayAssessment.PROFILEID,
      isRequired: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
...
class _AggregateDayAssessmentModelType extends amplify_core.ModelType<AggregateDayAssessment> {
  const _AggregateDayAssessmentModelType();
  
  @override
  AggregateDayAssessment fromJson(Map<String, dynamic> jsonData) {
    return AggregateDayAssessment.fromJson(jsonData);
  }
  
  @override
  String modelName() {
    return 'AggregateDayAssessment';
  }
}
