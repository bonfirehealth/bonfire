...
/** This is an auto generated class representing the AggregateMonthAssessment type in your schema. */
class AggregateMonthAssessment extends amplify_core.Model {
  static const classType = const _AggregateMonthAssessmentModelType();
  final String id;
  ...
  bool operator ==(Object other) {
    ...
    return other is AggregateMonthAssessment &&
      id == other.id &&
  ...
  String toString() {
    ...
    buffer.write("AggregateMonthAssessment {");
    buffer.write("id=" + "$id" + ", ");
  ...
  AggregateMonthAssessment copyWith({String? id, amplify_core.TemporalDateTime? startDate, amplify_core.TemporalDateTime? endDate, String? latestMood, String? latestStressLevel, double? averageOxygenLevel, double? averageOxygenSaturationLevel, double? averageRespiratoryRate, double? averageStressIndex, double? averageBodyTemperature, double? averageSystolicBloodPressure, double? averageDiastolicBloodPressure, double? averageHeartRate, double? averageHeartRateVariability, double? averageSympatheticNervousSystemIndex, double? averageScore, int? numberOfAssessments, String? profileID}) {
    return AggregateMonthAssessment._internal(
      id: id ?? this.id,
  ...
  AggregateMonthAssessment copyWithModelFieldValues({
  ...
  AggregateMonthAssessment.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "AggregateMonthAssessment";
    modelSchemaDefinition.pluralName = "AggregateMonthAssessments";
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateMonthAssessment.STARTDATE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.dateTime)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateMonthAssessment.ENDDATE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.dateTime)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateMonthAssessment.LATESTMOOD,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateMonthAssessment.LATESTSTRESSLEVEL,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateMonthAssessment.AVERAGEOXYGENLEVEL,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateMonthAssessment.AVERAGEOXYGENSATURATIONLEVEL,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateMonthAssessment.AVERAGERESPIRATORYRATE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateMonthAssessment.AVERAGESTRESSINDEX,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateMonthAssessment.AVERAGEBODYTEMPERATURE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateMonthAssessment.AVERAGESYSTOLICBLOODPRESSURE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateMonthAssessment.AVERAGEDIASTOLICBLOODPRESSURE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateMonthAssessment.AVERAGEHEARTRATE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateMonthAssessment.AVERAGEHEARTRATEVARIABILITY,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateMonthAssessment.AVERAGESYMPATHETICNERVOUSSYSTEMINDEX,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateMonthAssessment.AVERAGESCORE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.double)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateMonthAssessment.NUMBEROFASSESSMENTS,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: AggregateMonthAssessment.PROFILEID,
      isRequired: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
...
class _AggregateMonthAssessmentModelType extends amplify_core.ModelType<AggregateMonthAssessment> {
  const _AggregateMonthAssessmentModelType();
  
  @override
  AggregateMonthAssessment fromJson(Map<String, dynamic> jsonData) {
    return AggregateMonthAssessment.fromJson(jsonData);
  }
  
  @override
  String modelName() {
    return 'AggregateMonthAssessment';
  }
}
